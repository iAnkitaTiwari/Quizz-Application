...
urlpatterns = [
    ...
    path('admin-view-add-complexity', views.admin_view_add_complexity,name='admin-add-view-complexity'),
    path('admin-add-complexity', views.admin_add_complexity,name='admin-add-complexity'),
    path('admin-view-complexity', views.admin_view_complexity,name='admin-view-complexity'),
